...
def parse_args():
    ...
    # 基本参数
    parser.add_argument('--output_dir', type=str, default='./results_AutoTabPFN/best_7_features',
    ...
    parser.add_argument('--ges_scoring', type=str, default='roc',
    ...
    parser.add_argument('--validation_method', type=str, default='holdout',
                        choices=['holdout', 'cv'],
                        help='Validation method to use')
    parser.add_argument('--n_repeats', type=int, default=80,
    ...
    parser.add_argument('--ges_n_iterations', type=int, default=25,
