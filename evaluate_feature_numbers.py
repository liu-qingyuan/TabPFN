...
# 定义要测试的特征数量
feature_numbers = list(range(3, 64))  # 测试3到63个特征

# 存储所有结果
all_results = []

# 对每个特征数量进行评估
for n_features in tqdm(feature_numbers, desc=f"Evaluating features (3-63)"):
    # 选择前n个特征
...
print("2. results/feature_number_evaluation/performance_comparison.png") 