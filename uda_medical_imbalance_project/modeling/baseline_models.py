"""
UDA Medical Imbalance Project - 基线模型实现
...
class PKUPHModel(BaseEstimator, ClassifierMixin):
    """
    PKUPH模型的实现
...
class MayoModel(BaseEstimator, ClassifierMixin):
    """
    Mayo模型的实现
