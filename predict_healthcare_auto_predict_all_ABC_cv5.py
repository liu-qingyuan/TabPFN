...
def run_experiment(
    ...
    max_time=15,
    random_state=42,
    base_path='./results/combined_tabpfn_cv5'
):
    """
    Run AutoTabPFN experiment with 5-fold cross-validation
...
if __name__ == "__main__":
    ...
    os.makedirs('./results/combined_tabpfn_cv5', exist_ok=True)
    combined_df.to_excel('./results/combined_tabpfn_cv5/combined_dataset.xlsx', index=False)
