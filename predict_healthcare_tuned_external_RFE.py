...
os.makedirs('./results/rfe_analysis', exist_ok=True)
...
base_model = TunedTabPFNWrapper(device='cuda', random_state=42, n_trials=50)
rfe = RFE(
...
feature_ranks.to_csv('./results/rfe_analysis/feature_ranking.csv', index=False)
...
# Save results
results_df.to_csv('./results/rfe_analysis/feature_selection_results.csv', index=False)
...
plt.tight_layout()
plt.savefig('./results/rfe_analysis/performance_analysis.png', dpi=300, bbox_inches='tight')
plt.show()

print("\nResults have been saved to:")
print("1. ./results/rfe_analysis/feature_ranking.csv")
print("2. ./results/rfe_analysis/feature_selection_results.csv")
print("3. ./results/rfe_analysis/performance_analysis.png") 