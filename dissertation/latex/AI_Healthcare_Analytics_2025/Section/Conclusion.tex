...
This dissertation introduced PANDA, a framework that links pre-trained tabular foundation models to the practical constraints of medical tabular data, including small sample sizes, feature heterogeneity, and distribution shifts. Experiments on private cross-hospital cohorts and public benchmarks demonstrate that:
