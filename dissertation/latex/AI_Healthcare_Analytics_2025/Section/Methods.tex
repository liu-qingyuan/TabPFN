...
\begin{itemize}
    \item \textbf{Mayo model}: $\text{Prob} = \sigma(-6.83 + 0.039 \cdot \text{Age} + 0.79 \cdot \text{Smoke} + 1.34 \cdot \text{CancerHx} + 0.13 \cdot \text{Diameter} + 1.04 \cdot \text{Spiculation} + 0.78 \cdot \text{UpperLobe})$.
