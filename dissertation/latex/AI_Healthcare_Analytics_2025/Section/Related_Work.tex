...
garau_external_2020}. External validations on LIDC-IDRI, LUNA16, and NLST repeatedly
report double-digit AUC drops when deployed to scanners with different kernels or
patient mixes, while shortcut-learning analyses show that models sometimes rely on
grid artifacts or reconstruction noise rather than morphology~\cite{ardila_end--end_2019,
...
reporting on cross-hospital generalization or calibration.
...
distributions without assuming access to large labeled target cohorts. Addressing
...
noauthor_mlfoundationstableshift_nodate}. In this sense, PANDA fills the gap between
