...
Table~\ref{tbl:theory_empirics} summarizes the connection between the theoretical components and our experimental findings, and illustrates how each PANDA component targets a specific term in the Ben-David bound.

\begin{table}[htbp]
\centering
\caption{Mapping theoretical error terms to PANDA components and empirical results.}
\label{tbl:theory_empirics}
\resizebox{\textwidth}{!}{%
\begin{tabular}{llll}
\toprule
